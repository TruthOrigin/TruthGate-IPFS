    ...
    IOptions<PortOptions> ports) =>
                ...
                IOptions<PortOptions> ports) =>
            {
                ...
                if (!isAuthed)
                {
                    ...
                    var targetUriAuthedless = RequestHelpers.CombineTargetHttp("ipfs", rest, context, 5001);
                ...
                var targetUriAuthed = RequestHelpers.CombineTargetHttp("ipfs", normalizedRest, context, 5001);
